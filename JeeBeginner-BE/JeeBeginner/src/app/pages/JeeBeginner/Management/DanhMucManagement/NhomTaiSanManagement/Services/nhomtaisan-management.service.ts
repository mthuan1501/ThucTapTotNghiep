...
const API_PRODUCTS_URL = environment.ApiRoot + "/dm_nhomtaisan";
...
@Injectable()
export class NhomTaiSanManagementService {
  // Private fields
  private _items$ = new BehaviorSubject<NhomTaiSanModel[]>([]);
  private _itemstemp$ = new NhomTaiSanModel();
  ...
  setitemstemp(value: NhomTaiSanModel) {
  ...
  public fetch() {
    ...
    const request = this.findData(this._tableState$.value)
      .pipe(
        tap((res: ResultModel<NhomTaiSanModel>) => {
          if (res && res.status === 1) {
  ...
  private findData(tableState: ITableState): Observable<any> {
    ...
    const url = API_PRODUCTS_URL + "/DM_NhomTaiSan_List";
    return this.http
  ...
  DM_NhomTaiSan_Insert(item: NhomTaiSanModel): Observable<any> {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    const url = API_PRODUCTS_URL + "/DM_NhomTaiSan_Insert";
    return this.http.post<any>(url, item, { headers: httpHeaders });
  }
  UpdateNhomTaiSan(item: NhomTaiSanModel): Observable<any> {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    const url = API_PRODUCTS_URL + "/UpdateNhomTaiSan";
    return this.http.post<any>(url, item, { headers: httpHeaders });
  }
  DeleteNhomTaiSan(item: NhomTaiSanModel): Observable<any> {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    const url = API_PRODUCTS_URL + "/DeleteNhomTaiSan";
    return this.http.post<any>(url, item, { headers: httpHeaders });
  }
  ...
  GetNhomTaiSanID(IdPNTS: number): Observable<any> {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    const url = API_PRODUCTS_URL + `/GetNhomTaiSanID?IdPNTS=${IdPNTS}`;
    return this.http.get<any>(url, { headers: httpHeaders });
  }

  SearchNhomTaiSan(TenNhom: string): Observable<any> {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    const url = API_PRODUCTS_URL + `/SearchNhomTaiSan?TenNhom=${TenNhom}`;
    return this.http.get<any>(url, { headers: httpHeaders });
  }
