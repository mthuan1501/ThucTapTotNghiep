...
const API_PRODUCTS_URL = environment.ApiRoot + "/dm_loaitaisan";
...
export class LoaiTaiSanManagementService {
  ...
  private _itemstemp$ = new LoaiTaiSanModel();
  ...
  setitemstemp(value: LoaiTaiSanModel) {
  ...
  private findData(tableState: ITableState): Observable<any> {
    ...
    const url = API_PRODUCTS_URL + "/DM_LoaiTaiSan_List";
    return this.http
  ...
  DM_LoaiTaiSan_Insert(item: LoaiTaiSanModel): Observable<any> {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    const url = API_PRODUCTS_URL + "/DM_LoaiTaiSan_Insert";
    return this.http.post<any>(url, item, { headers: httpHeaders });
  }
  UpdateLoaiTaiSan(item: LoaiTaiSanModel): Observable<any> {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    const url = API_PRODUCTS_URL + "/UpdateLoaiTaiSan";
    return this.http.post<any>(url, item, { headers: httpHeaders });
  }
  DeleteLoaiTaiSan(item: LoaiTaiSanModel): Observable<any> {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    const url = API_PRODUCTS_URL + "/DeleteLoaiTaiSan";
    return this.http.post<any>(url, item, { headers: httpHeaders });
  }
  ...
  GetLoaiTaiSanID(IdLoaiTS: number): Observable<any> {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    const url = API_PRODUCTS_URL + `/GetLoaiTaiSanID?IdLoaiTS=${IdLoaiTS}`;
    return this.http.get<any>(url, { headers: httpHeaders });
  }

  SearchLoaiTaiSan(TenLoai: string): Observable<any> {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    const url = API_PRODUCTS_URL + `/SearchLoaiTaiSan?TenLoai=${TenLoai}`;
    return this.http.get<any>(url, { headers: httpHeaders });
  }
