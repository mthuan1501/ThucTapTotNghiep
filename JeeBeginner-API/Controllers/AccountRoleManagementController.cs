...
namespace JeeBeginner.Controllers
{
    ...
    public class AccountRoleManagementController : ControllerBase
    {
        ...
        [HttpPost("Get_DS")]
        public async Task<object> layds([FromBody] QueryRequestParams query)
        {
            try
            {
        ...
        public async Task<object> layalltk([FromBody] QueryRequestParams query)
        {
            try
            {
                var user = Ulities.GetUserByHeader(HttpContext.Request.Headers, _jwtSecret);
        ...
        public async Task<object> taotk(AccountRoleModel accountModel)
        {
            try
            {
                var user = Ulities.GetUserByHeader(HttpContext.Request.Headers, _jwtSecret);
        ...
        public async Task<object> capnhattk(AccountRoleModel accountModel)
        {
            try
            {
                var user = Ulities.GetUserByHeader(HttpContext.Request.Headers, _jwtSecret);
        ...
        public async Task<object> luu(List<AccountRole> arr_data)
        {
            try
            {
                var user = Ulities.GetUserByHeader(HttpContext.Request.Headers, _jwtSecret);
        ...
        public async Task<object> chiXem(string roleName)
        {
            try
            {
                var user = Ulities.GetUserByHeader(HttpContext.Request.Headers, _jwtSecret);
